...
###The file **"main_data_plots.mat"** contains the same data as "main_data.mat" but reformatted to exclude sweeping stimuli which were not analysed in the manuscript.
- **sorted_by_max**
- 
###The file "main_data_autobehv_newThr" contains the automated behaviour classification.

###The file **"main_data_perAnimalInfo.mat"**

###The file **"main_data_taken.mat"**

###The file **"index_helpers.mat"**
